      ...
      <section className="flex justify-center items-center h-screen flex-col">
        <form className="flex flex-col gap-8 bg-white/5 p-4 rounded-lg">
          ...
          <textarea
            ...
            placeholder="Mensaje"
          ></textarea>
          <button class="cursor-pointer transition-all bg-indigo-500 text-white font-medium px-6 py-2 rounded-lg border-indigo-600 border-b-[4px] hover:brightness-110 hover:-translate-y-[1px] hover:border-b-[6px] active:border-b-[2px] active:brightness-90 active:translate-y-[2px]">
            Enviar
          </button>
        </form>
      </section>
